          ...
          <header className="flex flex-col gap-4 pt-4 sm:pt-8">
            ...
            <div className="flex w-full flex-col gap-4 md:flex-row md:items-end md:justify-between">
              <div className="w-full">
                <h1 className="ml-auto max-w-[24ch] pl-10 text-right text-[16px] leading-snug text-[#2a1248] sm:ml-0 sm:max-w-none sm:text-left sm:text-5xl sm:pl-0">
                  Shareable shopping magic with a Kuromi edge.
                </h1>
                <p className="mt-3 ml-auto max-w-[24ch] pl-10 text-right text-[11px] text-[#5b2aaa] sm:ml-0 sm:max-w-2xl sm:text-left sm:text-base sm:pl-0">
